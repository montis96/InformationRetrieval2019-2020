...
for file in all_files:
    csv = pd.read_csv("D:\\Sgmon\\Git\\InformationRetrieval2019-2020\\IRproject\\results\\titles\\" + file,
                      header=None)
    bm25 = pd.read_csv("D:\\Sgmon\\Git\\InformationRetrieval2019-2020\\IRproject\\results\\Wordnet\\" + file,
                       header=None)
